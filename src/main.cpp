...
unsigned int nStakeMaxAge = 15 * 24 * 60 * 60;           // 30 days
...
const string strMessageMagic = "majesticcoin Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    if (IsProofOfWork())
    {
        ...
        if (vtx[0].GetValueOut() > nReward && pindexBest->nHeight+1!=1)
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "majesticcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Only the rich are worthy - majesticcoin 21st July";
        CTransaction txNew;
        txNew.nTime = 1405883215;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xe72ba634db70a7e065f17f41f434cedf449c435bd63cd096760ed5af4e2965f8"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xe1, 0xe0, 0xe2, 0xe3 };
