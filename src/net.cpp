...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("majesticcoin-ext-ip");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("majesticcoin-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "majesticcoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    	{"216.189.153.244", "216.189.153.244"},
        {"104.206.168.151", "104.206.168.151"},
        {"104.140.105.42", "104.140.105.42"},
        {"192.169.6.108", "192.169.6.108"},
        {"104.140.105.45", "104.140.105.45"},
        {"104.206.168.151", "104.206.168.151"},
        {"192.169.6.67", "192.169.6.67"},
        {"104.31.79.67", "104.31.79.67"},
        {"104.206.168.149", "104.206.168.149"},
        {"104.206.168.150", "104.206.168.150"},
        {"104.206.168.151", "104.206.168.151"},
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("majesticcoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("majesticcoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("majesticcoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("majesticcoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. majesticcoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("majesticcoin-start");
